...
def fetch_hourly_data_for_date_range(start_date, end_date):
    ...
    for current_date in date_range:
        ...
        end_datetime = f"{current_date_str} 12:00:00"
        ...
        if hourly_data is not None and not hourly_data.empty:
            ...
            filtered_data = filtered_data[(filtered_data['hour'] >= 0) & (filtered_data['hour'] <= 11)]
    ...
    columns_to_remove = ['open', 'high', 'low', 'tick_volume', 'spread', 'real_volume', 'hour']
...
if is_training_actual_price_movement:
    ...
    create_diagrams(strategy_data_in_sample, name_of_folder)
